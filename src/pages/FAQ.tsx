...
const FAQ = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-40 pb-16 bg-primary">
        <div className="container mx-auto px-6 text-center">
          <ScrollAnimationWrapper>
            <p className="text-accent text-xs tracking-[0.3em] uppercase font-body mb-3">{t("faq")}</p>
            <h1 className="text-4xl md:text-5xl font-serif text-primary-foreground mb-4">{t("faqTitle")}</h1>
          </ScrollAnimationWrapper>
        </div>
      </section>
      ...
      {/* Disclaimer Section */}
      <section className="py-20 bg-secondary/10" id="disclaimer">
        <div className="container mx-auto px-6 max-w-3xl">
          <ScrollAnimationWrapper>
