...
import { Stethoscope, Shield, Bed, ClipboardList, Scale, Globe, CheckCircle2, Phone, Clock, Wifi, Tv, Newspaper, UtensilsCrossed, Sparkles, Search, AlertTriangle, Baby, Lock, Radio, Users } from "lucide-react";
            ...
            {show("trackerwave") && <div id="section-trackerwave" className={sectionClass}>
              <ScrollAnimationWrapper>
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-2xl md:text-3xl font-serif text-foreground">{lang === "ar" ? "نظام أمان الرضّع TrackerWave" : "TrackerWave Infant Security System"}</h2>
                </div>

                <p className="font-body text-sm text-muted-foreground leading-relaxed mb-8">
                  {lang === "ar" ? "في مستشفى رويال حياة، سلامة كل مولود هي أولويتنا القصوى. نستخدم نظام TrackerWave RTLS، وهو نظام مراقبة متطور يعمل في الوقت الفعلي مصمم لتوفير حماية شاملة على مدار الساعة لكل رضيع في رعايتنا." : "At Royale Hayat Hospital, the safety of every newborn is our highest priority. We utilize the TrackerWave RTLS, a sophisticated real-time monitoring system designed to provide comprehensive, 24/7 protection for every infant in our care."}
                </p>
                ...
                <div className="mb-10 rounded-2xl overflow-hidden border border-border/50 bg-muted/30">
                  <div className="aspect-video flex items-center justify-center bg-muted/50">
                    <div className="text-center">
                      ...
                      <p className="font-serif text-lg text-foreground mb-1">{lang === "ar" ? "فيديو نظام TrackerWave" : "TrackerWave System Video"}</p>
