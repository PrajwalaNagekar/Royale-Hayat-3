...
const HospitalityServices = () => {
  ...
  return (
    <div className="min-h-screen bg-background pt-[var(--header-height,56px)]">
      ...
      {/* ===== OUR LUXURY HALLS ===== */}
      {show("halls") && <section className="py-2 bg-primary/5">
        <div className="container mx-auto px-6 max-w-6xl">
          <ScrollAnimationWrapper>
            {/* <h2 className="text-2xl md:text-3xl font-serif text-foreground mb-2 text-center">{isAr ? "قاعاتنا الفاخرة" : "Our Luxury Halls"}</h2> */}
            <div className="flex justify-center gap-2 flex-wrap mt-6 mb-10">
              {hallsNav.map((h) => (
      ...
      {/* ===== OUR LUXURY SUITES ===== */}
      {show("suites") && <section className="py-2 bg-primary/5">
        <div className="container mx-auto px-6 max-w-6xl">
          <ScrollAnimationWrapper>
            {/* <h2 className="text-2xl md:text-3xl font-serif text-foreground mb-2 text-center">{isAr ? "أجنحتنا الفاخرة" : "Our Luxury Suites"}</h2> */}
