        ...
        <div className="container mx-auto px-6 text-center">
          <ScrollAnimationWrapper>
            ...
            <h1 className="text-4xl md:text-5xl font-serif text-foreground mb-4">
              {lang === "ar" ? "نظام أمان الرضّع TrackerWave" : "TrackerWave Infant Security System"}
            </h1>
            <p className="text-muted-foreground font-body text-sm max-w-2xl mx-auto">
              {lang === "ar"
                ? "في مستشفى رويال حياة، سلامة كل مولود هي أولويتنا القصوى. نستخدم نظام TrackerWave RTLS، وهو نظام مراقبة متطور يعمل في الوقت الفعلي مصمم لتوفير حماية شاملة على مدار الساعة لكل رضيع في رعايتنا."
                : "At Royale Hayat Hospital, the safety of every newborn is our highest priority. We utilize the TrackerWave RTLS, a sophisticated real-time monitoring system designed to provide comprehensive, 24/7 protection for every infant in our care."}
            </p>
          </ScrollAnimationWrapper>
        </div>
      </section>
              ...
              <div className="aspect-video flex items-center justify-center bg-muted/50">
                <div className="text-center">
                  ...
                  <p className="font-serif text-xl text-foreground mb-2">
                    {lang === "ar" ? "فيديو نظام TrackerWave" : "TrackerWave System Video"}
                  </p>
                  <p className="font-body text-sm text-muted-foreground">
                    {lang === "ar" ? "سيتم إضافة الفيديو قريباً" : "Video coming soon"}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            <ScrollAnimationWrapper>
              <h2 className="text-2xl md:text-3xl font-serif text-foreground mb-8">
                {lang === "ar" ? "لماذا TrackerWave؟" : "Why TrackerWave?"}
              </h2>
