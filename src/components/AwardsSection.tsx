    ...
    <section className="py-20 bg-primary">
      <div className="container mx-auto px-6">
        ...
        <div className="relative flex flex-col lg:flex-row gap-6 max-w-6xl mx-auto items-stretch">
          {/* Left Arrow */}
          <button onClick={prev}
            className="absolute -left-5 top-1/2 -translate-y-1/2 z-10 w-9 h-9 rounded-full border border-white/20 bg-primary/80 backdrop-blur-sm flex items-center justify-center text-white hover:bg-accent hover:border-accent transition-colors shadow-md ltr-icon">
            <ChevronLeft className="w-4 h-4" />
          </button>
          {/* Right Arrow */}
          <button onClick={next}
            className="absolute -right-5 top-1/2 -translate-y-1/2 z-10 w-9 h-9 rounded-full border border-white/20 bg-primary/80 backdrop-blur-sm flex items-center justify-center text-white hover:bg-accent hover:border-accent transition-colors shadow-md ltr-icon">
          ...
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="lg:w-[420px] bg-white/10 backdrop-blur-sm border border-secondary/15 rounded-xl p-6 md:p-8 flex flex-col items-center justify-center text-center flex-shrink-0"
            >
