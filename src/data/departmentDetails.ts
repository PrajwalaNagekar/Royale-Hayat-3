...
export const departmentDetails: DepartmentDetail[] = [
    ...
    sections: [
      {
        ...
        content: "Supported by a team of over 600 healthcare professionals, including dedicated nurses, anesthetists, and neonatologists, we provide comprehensive care every step of the way. Our collaborative approach ensures personalized attention throughout pregnancy, delivery, and recovery.",
      },
      {
      ...
      },
      {
        ...
        items: [
          "9 private birthing suites",
          "6 Mimosa Suites for low-risk births",
          "2 High Dependency Units (HDUs)",
          "1 isolation room for special cases",
        ],
      },
      {
  ...
  {
    slug: "royale-home-health",
    name: "Royale Home Health",
    nameAr: "رويال للرعاية المنزلية",
    intro: "Premium medical care delivered in the comfort and privacy of your home by certified professionals.",
    sections: [],
  },
];
